...
public class File_ej {

	public static void main(String[] args) throws IOException {
		File quijote = new File("Quijote.txt");
		File quijote_salida = new File("Quijote_Salida.txt");
		String texto = "En un lugar de la Mancha, de cuyo nombre no quiero acordarme, "
				...
				+ "los días de entre semana se honraba con su vellori de lo más fino. Tenía en su casa una ama que pasaba de los cuarenta, "
		...
		OperacionesFicheros of = new OperacionesFicheros(quijote, quijote_salida, texto);
		if (of.escribir_fichero_car()== OperacionesFicheros.EXIT_RETURN) {
		}else if (of.leer_fichero_Buffered()== OperacionesFicheros.EXIT_RETURN){
		}else if (of.leer_fichero_escribir()== OperacionesFicheros.EXIT_RETURN) {
		}
	}
